...
class ControlServer:
    ...
    def _register_handlers(self) -> None:
        ...
        self._handler_map = {
            ...
            IPCMessageType.CMD_PAGE_SAVE_SITE: self._handlers.handle_cmd_page_save_site,
            IPCMessageType.CMD_PAGE_REMOVE_SITE: self._handlers.handle_cmd_page_remove_site,
            ...
            IPCMessageType.GET_ACTIVITY_HISTORY: self._handlers.handle_get_activity_history,
            ...
            IPCMessageType.CMD_BOUNDARY_SNAPSHOT: self._handlers.handle_cmd_boundary_snapshot,
            IPCMessageType.CMD_PROVISION_ADAPTER: self._handlers.handle_cmd_provision_adapter,
