...
- [x] 5.3 Verify daemon subprocess starts inside CI container (standalone mode, no shared instance) — confirmed via manual Argo workflow run `styrened-op-paths-v2`
