...
0.16.0 is a clean break. `CmdBlockPeerRequest.peer_hash` is removed entirely
and replaced with `identity_hash`. No compat shim. All callers updated simultaneously.

---

## CHANGED: CmdBlockPeerRequest
