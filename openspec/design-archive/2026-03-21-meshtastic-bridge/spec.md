# Meshtastic Bridge Service — Design Spec (extracted)

> Auto-extracted from docs/meshtastic-bridge.md at decide-time.

## Decisions

### Radio-only, no MQTT — local serial/BLE interface to Meshtastic hardware (decided)
